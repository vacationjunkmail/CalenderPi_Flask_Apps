...
pyscript_bp = Blueprint('pyscript_bp',__name__,template_folder='templates',static_folder='static')

@pyscript_bp.before_request
def before_request():
	g.db = get_connection()

@pyscript_bp.after_request
